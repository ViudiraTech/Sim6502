...
#define CPU_FREQ		4e6		// 处理器频率
#define STEP_DURATION	10e6	// 每个时钟周期的持续时间
#define ONE_SECOND		1e9		// 一秒钟内的纳秒数
#define NUM_MODES		14		// 指令模式的数量
#define NMI_VEC			0xFFFA	// 非屏蔽中断向量地址
#define RST_VEC			0xFFFC	// 复位中断向量地址
#define IRQ_VEC			0xFFFE	// 可屏蔽中断向量地址
